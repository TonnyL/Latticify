...
object ChannelsRepository : ChannelsDataSource {
    ...
    override fun archive(channelId: String): Observable<ResponseWrapper> =
            mChannelsService.archive(mToken,
                    channelId)

    override fun create(name: String,
                        validate: Boolean): Observable<ChannelWrapper> =
            mChannelsService.create(mToken,
                    name,
                    validate)
    ...
    override fun history(channelId: String,
            ...
            mChannelsService.history(mToken,
                    channelId,
                    count,
                    inclusive,
                    latest,
    ...
    override fun rename(channelId: String,
                        name: String,
                        validate: Boolean): Observable<ChannelWrapper> =
            mChannelsService.rename(mToken,
                    channelId,
                    name,
                    validate)
